...
class MyReorderableListView extends StatefulWidget {
  ...
  /// See also:
  ///
  ///   * [MyReorderableListView.builder], which allows you to build a reorderable
  ...
  /// [MyReorderableListView.builder] constructor. Using the [IndexedWidgetBuilder], The
...
class _MyReorderableListViewState extends State<MyReorderableListView> {
  ...
  Widget _itemBuilder(BuildContext context, int index) {
    ...
    assert(() {
      if (item.key == null) {
        throw FlutterError(
          'Every item of MyReorderableListView must have a key.',
        );
      }
      return true;
    }());
    ...
    final Key itemGlobalKey =
        _MyReorderableListViewChildGlobalKey(item.key!, this);
...
@optionalTypeArgs
class _MyReorderableListViewChildGlobalKey extends GlobalObjectKey {
  const _MyReorderableListViewChildGlobalKey(this.subKey, this.state)
      : super(subKey);
  ...
  bool operator ==(Object other) {
    ...
    return other is _MyReorderableListViewChildGlobalKey &&
        other.subKey == subKey &&
        other.state == state;
  }
